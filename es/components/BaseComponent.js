...
function createComponent(AntdComponent, mapProps) {
    ...
    _createClass(InputComponent, [{
      ...
      value: function render() {
        var _mapProps = mapProps(this.props),
            rest = _extends({}, _mapProps);

        return _react["default"].createElement("div", null, _react["default"].createElement(AntdComponent, rest));
      }
    }]);
  ...
  InputComponent.displayName = "Redux-form-ANTD-MOBILE".concat(AntdComponent.displayName);
  return InputComponent;
}